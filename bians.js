...
function 開始() {
  ...
  threads.start(function () {
    while (true) {
      ...
      if (基准值 < 1.007 && Number(當前價格) < Number(布林中 * 1.1) && Number(當前價格) > Number(布林中 * 1.0045)) {
        toastLog(當前價格 + " " + 布林中)
        toastLog("當前價格符合---- 做空")
      ...
      } else if (基准值 < 1.007 && Number(當前價格) < Number(布林中 / 1.0045)) {
        toastLog(當前價格 + " " + 布林中)
        toastLog("當前價格符合---- 做多")
        sleep(300)
      ...
      else if (基准值 > 1.007 && 基准值 < 1.008 && Number(當前價格) < Number(布林中 / 1.015)) {
        toastLog(當前價格 + " " + 布林中)
        toastLog("當前價格符合---- 做多")
        sleep(300)
        id("com.binance.dev:id/2131362712").text("買入").findOne().click()
      ...
      else if (基准值 > 1.007 && 基准值 < 1.008 && Number(當前價格) < Number(布林中 * 1.2) && Number(當前價格) > Number(布林中 * 1.015)) {
        toastLog(當前價格 + " " + 布林中)
        toastLog("當前價格符合---- 做空")
