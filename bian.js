...
threads.start(function () {
    ...
    window.setPosition(device.width - 120, (device.height - 1250));
...
threads.start(function () {
    ...
    window.setPosition(device.width - 120, (device.height - 1050));
...
threads.start(function () {
    ...
    window.setPosition(device.width - 120, (device.height - 850));
...
threads.start(function () {
    ...
    window.setPosition(device.width - 120, (device.height - 650));
